...
// Updating widget replacing old instances with new
	...
	public function getEnquiryForm($enquiryFormValues, $enquiryFormErrors, $maxUploadSize)
	{
		...
		$datenschutz = __('Durch Absenden dieses Formulars bestätige ich die Kenntnis der Datenschutzerklärung und bin mit dem Senden und Speichern meiner Daten einverstanden.', 'traduset');
